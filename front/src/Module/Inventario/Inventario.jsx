...
function Inventario() {
    ...
    useEffect(() => {
        const timerId = setTimeout(() => {
          if (productosData.length === 0 && !error) { // Verificar que no haya error para mostrar el mensaje
    ...
    useEffect(() => {
        ...
        if (stock) {
            ...
            if(stock === "Escaso"){
                resultado = resultado.filter(
                    (producto) => producto.stock < producto.stockMinimo && producto.stock > 0
                );
            }
            if(stock === "Nulo"){
                resultado = resultado.filter(
    ...
    const listaProductos = productosFiltrados.slice(primerIndex, siguienteIndex).map((producto) => (
        <ItemTabla producto={producto} key={producto._id} />
    ));
        ...
        <main className="container mx-auto px-10 pt-10   self-center  lg:px-32 lg:pt-16   xl:px-24 xl:   2xl:px-32 2xl:pt-28  mt-20 ">
            ...
            <div className="w-full flex justify-between items-center ">
                <div className=" flex items-center gap-4">
                    ...
                    <DropdownFilterComponent categorias={categorias} filterCategory={filterCategory} filterStock={filterStock} categoriaActual={categoria} stockActual={stock}/>
            ...
            <div className="h-28 flex justify-center items-center">
                <PaginationComponent
                    productosPorPagina={productosPorPagina} // Número de productos por página
                    paginaActual={paginaActual} // Página actual
                    totalProductos={totalProductos} // Total de productos filtrados
            ...
            {mostrarMensaje && (
                <>
                    <div className="mt-16 ">
                        <div className="px-10 py-4  w-full md:w-3/4 xl:w-1/2 2xl:w-2/5 mx-auto rounded-2xl shadow-lg border border-slate-200">
